            ...
            <main>
                <div className="flex h-screen">
                    <div className="m-auto text-right w-full pr-20">
                        <a href="/gallery/bw" className="text-2xl sm:text-4xl foundersFont hover:text-gray-600">black & white</a>
                        <div className="py-1"></div>
                        <a href="/gallery/color" className="text-2xl sm:text-4xl foundersFont">
